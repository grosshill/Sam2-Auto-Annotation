...
class CUDADetector:
    ...
    def __init__(
        ...
        try:
            ...
            # Avoid leaked context if constructor fails halfway.
            try:
    ...
    def postprocess_output(self, output):
        ...
        if 0 < self.pre_nms_topk < scores.size:
    ...
    def shutdown(self):
        ...
        try:
            self.cuda_ctx.detach()
            if self.debug:
                print("PyCUDA context detached.")
        except Exception as e:
            print(f"PyCUDA shutdown error: {e}")

if __name__ == '__main__':
    # det = CUDADetector("./stage1_half_fp16.engine", debug=True)
    det = CUDADetector(
        #"./stage1.engine",
        #"./stage2_green_bg_yellow_target.engine",
        "./stage3_mix.engine",
        debug=True,
        enable_nms=True,
        conf_thres=0.25,
